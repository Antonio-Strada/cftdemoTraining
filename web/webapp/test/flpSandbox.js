		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CF demo non-CAP S0023961268",
									"targetURL": "#comxtendhrweb-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comxtendhrweb-display": {
								"semanticObject": "comxtendhrweb",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.xtendhr.web",
									"url": sap.ui.require.toUrl("com/xtendhr/web")
								}
							}
						}
					}
